...
export default function Header() {
  ...
  useEffect(() => {
    const checkScreenSize = () => {
      setIsMobileView(window.innerWidth < 1405);
    };
  ...
  return (
    <header className="bg-black border-b border-gray-800 px-6 py-3 flex items-center justify-between relative">
      ...
      <div className="flex items-center space-x-4 2xl:space-x-12 text-xs 2xl:text-md">
        ...
        {/* Desktop Content - Hide on mobile when menu is available */}
        <div className={`${isMobileView ? 'hidden' : 'flex'} items-center space-x-4 2xl:space-x-12`}>
